...
```{r bear, echo=FALSE, fig.cap="A caption", out.width = '40%'}
...
There is the version that Lizzie created for 2019. The colour coding is percentiles relative to monthly values. 

```{r grid, echo=FALSE, fig.cap="2019 AQI levels coloured by percentile", out.width = '40%'}
